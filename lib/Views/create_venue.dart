              ...
              Container(
                ...
                _profileImage != null
                    ...
                    : Container(
                        ...
                        decoration: BoxDecoration(
                            image:
                                DecorationImage(image: AssetImage('assets/icons/dotContainer.png'), fit: BoxFit.fill)),
                        child: GestureDetector(
                          ...
                          child: Column(children: [
                            ...
                            Text.rich(TextSpan(
                                ...
                                children: <InlineSpan>[TextSpan(text: ' image to upload', style: Boldt16)])),
              ...
              Wrap(
                  ...
                  children: _availableTimeSlots.map((slot) {
                    return Container(
                        ...
                        child:
                            Text('${slot.startTime} - ${slot.endTime}', style: Lightt11.copyWith(color: Colors.black)));
                  }).toList()),
              SizedBox(height: 10),
              SizedBox(
                width: 130,
